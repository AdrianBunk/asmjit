...
struct EmitterExplicitT {
  ...
  ASMJIT_INST_1c(hlt, Inst::kIdHlt, Imm)
  ...
  ASMJIT_INST_2c(ldm, Inst::kIdLdm, Mem, Unknown)
  ASMJIT_INST_2c(ldmda, Inst::kIdLdmda, Mem, Unknown)
  ASMJIT_INST_2c(ldmdb, Inst::kIdLdmdb, Mem, Unknown)
  ASMJIT_INST_2c(ldmib, Inst::kIdLdmib, Mem, Unknown)
  ...
  ASMJIT_INST_1c(pop, Inst::kIdPop, Unknown)
  ASMJIT_INST_1c(push, Inst::kIdPush, Gp)
  ASMJIT_INST_1c(push, Inst::kIdPush, Unknown)
  ...
  ASMJIT_INST_1x(rfe, Inst::kIdRfe, Mem)
  ...
  ASMJIT_INST_2x(srs, Inst::kIdSrs, Mem, Imm)
  ...
  ASMJIT_INST_2c(stm, Inst::kIdStm, Mem, Unknown)
  ASMJIT_INST_2c(stmda, Inst::kIdStmda, Mem, Unknown)
  ASMJIT_INST_2c(stmdb, Inst::kIdStmdb, Mem, Unknown)
  ASMJIT_INST_2c(stmib, Inst::kIdStmib, Mem, Unknown)
  ...
  ASMJIT_INST_2c(vabs_f16, Inst::kIdVabs | kDT1_F16, Vec, Vec)
  ...
  ASMJIT_INST_3c(vadd_f16, Inst::kIdVadd | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_2c(vcmp_f16, Inst::kIdVcmp | kDT1_F16, Vec, Vec)
  ASMJIT_INST_2c(vcmp_f32, Inst::kIdVcmp | kDT1_F32, Vec, Vec)
  ASMJIT_INST_2c(vcmp_f16, Inst::kIdVcmp | kDT1_F16, Vec, Imm)
  ...
  ASMJIT_INST_2c(vcmpe_f16, Inst::kIdVcmpe | kDT1_F16, Vec, Vec)
  ASMJIT_INST_2c(vcmpe_f32, Inst::kIdVcmpe | kDT1_F32, Vec, Vec)
  ASMJIT_INST_2c(vcmpe_f16, Inst::kIdVcmpe | kDT1_F16, Vec, Imm)
  ...
  ASMJIT_INST_2c(vcvtr_s32_f16, Inst::kIdVcvtr | kDT1_S32 | kDT2_F16, Vec, Vec)
  ASMJIT_INST_2c(vcvtr_u32_f16, Inst::kIdVcvtr | kDT1_U32 | kDT2_F16, Vec, Vec)
  ...
  ASMJIT_INST_3c(vdiv_f16, Inst::kIdVdiv | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_3c(vfma_f16, Inst::kIdVfma | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_3c(vfms_f16, Inst::kIdVfms | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_3c(vfnma_f16, Inst::kIdVfnma | kDT1_F16, Vec, Vec, Vec)
  ASMJIT_INST_3c(vfnma_f32, Inst::kIdVfnma | kDT1_F32, Vec, Vec, Vec)
  ASMJIT_INST_3c(vfnma_f64, Inst::kIdVfnma | kDT1_F64, Vec, Vec, Vec)
  ASMJIT_INST_3c(vfnms_f16, Inst::kIdVfnms | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_2c(vjcvt_s32_f64, Inst::kIdVjcvt | kDT1_S32 | kDT2_F64, Vec, Vec)
  ...
  ASMJIT_INST_2c(vldr_16, Inst::kIdVldr | kDT1_16, Vec, Mem)
  ...
  ASMJIT_INST_3c(vmla_f16, Inst::kIdVmla | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_3c(vmls_f16, Inst::kIdVmls | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_2c(vmov_f16, Inst::kIdVmov | kDT1_F16, Vec, Imm)
  ...
  ASMJIT_INST_3c(vmul_f16, Inst::kIdVmul | kDT1_F16, Vec, Vec, Vec)
  ...
  ASMJIT_INST_2x(vneg_f32, Inst::kIdVneg | kDT1_F32, Vec, Vec)
  ...
  ASMJIT_INST_2c(vsqrt_f16, Inst::kIdVsqrt | kDT1_F16, Vec, Vec)
  ...
  ASMJIT_INST_2c(vstr_16, Inst::kIdVstr | kDT1_16, Vec, Mem)
  ASMJIT_INST_2c(vstr_32, Inst::kIdVstr | kDT1_32, Vec, Mem)
  ASMJIT_INST_2c(vstr_64, Inst::kIdVstr | kDT1_64, Vec, Mem)
  ASMJIT_INST_3c(vsub_f16, Inst::kIdVsub | kDT1_F16, Vec, Vec, Vec)
